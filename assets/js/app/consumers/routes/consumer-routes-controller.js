...
(function () {
  ...
  angular.module('frontend.consumers').controller('ConsumerRoutesController', [
    '_',
    '$scope',
    '$q',
    '$stateParams',
    ...
    function controller(
      ...
      $scope = angular.extend(
        $scope,
        angular.copy(ListConfig.getConfig('consumerRoute', RouteModel))
      );
      ...
      function _fetchData() {
        $scope.loading = true;
        ConsumerService.listRoutes($stateParams.id).then(function (res) {
