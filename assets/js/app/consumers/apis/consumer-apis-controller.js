...
(function () {
  ...
  angular.module('frontend.consumers').controller('ConsumerApisController', [
    '_',
    '$scope',
    '$stateParams',
    '$log',
    ...
    function controller(
      ...
      $scope = angular.extend(
        $scope,
        angular.copy(ListConfig.getConfig('consumerApi', ApiModel))
      );
      ...
      function fetchApis() {
        ConsumerService.listApis($stateParams.id).then(function (res) {
