...
(function () {
  ...
  angular.module('frontend.routes').controller('RouteHealthChecksController', [
    '$scope',
    '$log',
    '$state',
    'RouteService',
    ...
    function controller(
      ...
      $scope.toggleRouteHC = function () {
        RouteHCModel.update($scope.routeHC.id, {
          active: $scope.routeHC.active,
        }).then(
          function (updated) {
            MessageService.success(
              '健康检查' + ($scope.routeHC.active ? '已启用' : '已禁用')
            );
          },
          function (err) {
            //
      ...
      $scope.save = function () {
        ...
        RouteHCModel.update($scope.routeHC.id, $scope.routeHC).then(
          function (updated) {
            MessageService.success('路由健康检查已更新！');
          },
          function (err) {
            //
          }
