...
(function () {
  ...
  angular.module('frontend.users').controller('UsersController', [
    '_',
    '$scope',
    '$q',
    '$log',
    ...
    function controller(
      ...
      $scope = angular.extend(
        $scope,
        angular.copy(ListConfig.getConfig('user', UserModel))
      );
            ...
            UserModel.delete(user.id)
              ...
              .catch((err) => {
                ...
                MessageService.error(
                  _.get(err, 'data.message', 'Failed to delete user')
                );
              });
          },
          function decline() {}
      ...
      function _fetchData() {
        ...
        // Fetch data count
        var count = UserModel.count(commonParameters).then(function onSuccess(
          response
        ) {
