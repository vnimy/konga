(function () {
  ...
  angular
    .module('frontend.core.directives')
    .directive('rawView', function directive() {
      return {
        ...
        replace: true,
        template:
          '<span class="text-nowrap clickable" data-ng-click="openRawView(item)"><i uib-tooltip="原始数据" class="mdi mdi-eye-outline"></i>{{text ? "&nbsp;&nbsp;" + text : ""}}</span>',
        controller: [
          '$scope',
          '$uibModal',
