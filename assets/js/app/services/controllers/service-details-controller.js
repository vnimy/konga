...
(function () {
  ...
  angular.module('frontend.services').controller('ServiceDetailsController', [
    '_',
    '$scope',
    '$rootScope',
    '$log',
    ...
    function controller(
      ...
      function isKongUsingPostgres() {
        return (
          _.get($rootScope.Gateway, 'configuration.database') === 'postgres'
        );
      }
