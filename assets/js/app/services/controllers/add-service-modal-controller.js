...
(function () {
  ...
  angular.module('frontend.services').controller('AddServiceModalController', [
    '$scope',
    '$rootScope',
    '$log',
    '$state',
    ...
    function controller(
      ...
      $scope.tags = [];
      var availableFormattedVersion =
        ServiceService.getLastAvailableFormattedVersion(
          $rootScope.Gateway.version
        );
      $scope.service = angular.copy(
        ServiceService.getProperties($rootScope.Gateway.version)
      );

      $scope.partial =
        'js/app/services/partials/form-service-' +
