...
(function () {
  ...
  angular.module('frontend.upstreams').controller('UpstreamsController', [
    '_',
    '$scope',
    '$rootScope',
    '$q',
    ...
    function controller(
      ...
      $scope = angular.extend(
        $scope,
        angular.copy(ListConfig.getConfig('upstream', Upstream))
      );
      ...
      $scope.openCreateItemModal = function () {
        $uibModal.open({
          ...
          templateUrl:
            'js/app/upstreams/add-upstream-modal.html?v=' +
            $rootScope.konga_version,
      ...
      $scope.openAlertsListModal = () => {
        $uibModal.open({
          ...
          ariaDescribedBy: 'modal-body',
          templateUrl:
            'js/app/upstreams/alerts/alerts-modal.html?v=' +
            $rootScope.konga_version,
