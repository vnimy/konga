...
(function () {
  ...
  angular.module('frontend.upstreams').controller('EditUpstreamController', [
    '$scope',
    '$rootScope',
    '$stateParams',
    'UserService',
    ...
    function controller(
      ...
      $scope.sections = [
        ...
        {
          name: '报警 <span class="badge badge-danger pull-right">beta</span>',
          icon: 'mdi-bell',
        },
      ];
      ...
      function _fetchUpstream() {
        $scope.loading = true;
        Upstream.fetch($scope.upstreamId).then(
          function (resp) {
